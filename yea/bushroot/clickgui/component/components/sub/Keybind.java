...
public class Keybind extends Component
{
    ...
    public void renderComponent() {
        ...
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.binding ? "< PRESS KEY >" : ("Key: " + Keyboard.getKeyName(this.parent.mod.getKey())), (float)((this.parent.parent.getX() + 7) * 2), (float)((this.parent.parent.getY() + this.offset + 2) * 2 + 5), -1);
        GL11.glPopMatrix();
    }
